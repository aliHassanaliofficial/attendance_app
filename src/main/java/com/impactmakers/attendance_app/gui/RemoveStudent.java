...
import com.impactmakers.attendance_app.dbController.RemoveStu;
...
public class RemoveStudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        DELINPUT = new javax.swing.JFormattedTextField();
        ...
        jLabel4.setText("REMOVE EXISTING STUDENT");
        ...
        DELINPUT.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(227, 227, 227)));
        DELINPUT.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#0"))));
        DELINPUT.setAlignmentX(0.0F);
        DELINPUT.setCursor(new java.awt.Cursor(java.awt.Cursor.TEXT_CURSOR));
        DELINPUT.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        ...
        pointerSECTION.setFont(new java.awt.Font("Segoe UI Black", 0, 18)); // NOI18N
        pointerSECTION.setForeground(new java.awt.Color(242, 242, 242));
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(DELINPUT, javax.swing.GroupLayout.DEFAULT_SIZE, 656, Short.MAX_VALUE)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGap(20, 20, 20)
                                .addComponent(jLabel5))
                            .addComponent(pointerSECTION, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(404, 404, 404)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(jLabel5)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(DELINPUT, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(27, 27, 27)
                .addComponent(pointerSECTION, javax.swing.GroupLayout.PREFERRED_SIZE, 47, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(48, 48, 48)
                .addComponent(submitAttend)
    ...
    RemoveStu remover = new RemoveStu();
    private void submitAttendMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_submitAttendMouseClicked
        String getSTUID = DELINPUT.getText();
        int GOTSTUID = Integer.parseInt(getSTUID);
        remover.deleteStudent(GOTSTUID);

        switch (remover.logicistics) {
            case 1 -> {
                pointerSECTION.setText("Student has been successfully deleted from the system.");
                pointerSECTION.setForeground(new java.awt.Color(16, 81, 3));
            }
            case -1 -> {
                pointerSECTION.setText("Error while trying to find user, Maybe it is not existing. ");
    ...
    public javax.swing.JFormattedTextField DELINPUT;
